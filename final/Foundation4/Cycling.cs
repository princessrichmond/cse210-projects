...
public class Cycling: Activity{
    ...
    public Cycling(DateTime date, string activityType, int durationMinutes, double distance)
    ...
    public override string CalculatePace(){
        ...
        // double pace = _durationMinutes / _distance;
        // TimeSpan paceTime = TimeSpan.FromMinutes(pace * 60);
        // return $"{paceTime.Minutes} min {paceTime.Seconds} sec per mile";
    }
